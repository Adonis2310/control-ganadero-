 ...
 * panel orgánico flotante y misma composición móvil. Extraído tal cual del
 * login original de la Fase 1 (sección 3 de la Fase 13: no cambiar el
 * diseño) para no duplicar este marcado en cada pantalla nueva.
 */
